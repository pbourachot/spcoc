...
#    def __init__(self, client, client_secret, tokent, secret):
    def __init__(self, client, client_secret):
        self.client_id = client #options.get('client_id')
        self.client_secret = client_secret #options.get('client_secret')
        self.sandbox = False
        #self.sandbox = options.get('sandbox', True)
        
        default_service_host = 'cloud.feedly.com'
        self.service_host =  default_service_host
        self.additional_headers =  {}
        
        #self.token = token#options.get('token')
        #self.secret = secret #options.get('secret')
    ...
    def get_article_unread(self, access_token):
